...
@rem Portable vcvars by iFarbod. Determine the directory where this batch file is located
@set MSDevDir=%~dp0\..\..

@rem Define Visual Studio paths based on relative locations
@set VSINSTALLDIR=%MSDevDir%
@set VS100COMNTOOLS=%VSINSTALLDIR%\Common7\Tools\
@set VCINSTALLDIR=%VSINSTALLDIR%\VC\
@set WindowsSdkDir=%VSINSTALLDIR%\Microsoft SDKs\Windows\v7.0A\
